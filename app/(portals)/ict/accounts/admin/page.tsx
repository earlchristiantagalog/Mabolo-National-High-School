...
const MOCK_ADMINS = [
  { id: "A001", name: "Admin User", role: "System Admin", email: "admin@mnhs.edu.ph", status: "Active" },
  { id: "A002", name: "ICT Head", role: "ICT Coordinator", email: "ict.head@mnhs.edu.ph", status: "Active" },
];
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">
              Manage admin accounts — {MOCK_ADMINS.length} total
            </p>
          </div>
          <button
