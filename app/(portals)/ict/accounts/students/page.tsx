...
const MOCK_STUDENTS = [
  { id: "20260001", name: "Juan Dela Cruz", grade: "7", email: "juan.delacruz@mnhs.edu.ph", status: "Active" },
  { id: "20260002", name: "Maria Santos", grade: "8", email: "maria.santos@mnhs.edu.ph", status: "Active" },
  { id: "20260003", name: "Pedro Reyes", grade: "11", email: "pedro.reyes@mnhs.edu.ph", status: "Active" },
  { id: "20260004", name: "Ana Gonzales", grade: "12", email: "ana.gonzales@mnhs.edu.ph", status: "Inactive" },
  { id: "20260005", name: "Carlos Enriquez", grade: "10", email: "carlos.enriquez@mnhs.edu.ph", status: "Active" },
  { id: "20260006", name: "Rosa Villanueva", grade: "9", email: "rosa.villanueva@mnhs.edu.ph", status: "Active" },
  { id: "20260007", name: "Jose Rizal Jr.", grade: "11", email: "jose.rizaljr@mnhs.edu.ph", status: "Active" },
  { id: "20260008", name: "Luisa Mercado", grade: "7", email: "luisa.mercado@mnhs.edu.ph", status: "Inactive" },
];
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">
              Manage student accounts — {MOCK_STUDENTS.length} total
            </p>
          </div>
          <button
            onClick={() => setShowModal(true)}
            className="bg-[#8B1010] text-white text-xs sm:text-sm font-medium px-4 py-2 rounded-lg hover:bg-[#6e0d0d] transition-colors flex items-center gap-2 self-start"
          >
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="px-4 sm:px-6 py-3 text-[11px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wider">Grade</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {filtered.map((account) => (
                <tr key={account.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-600">{account.grade}</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">Grade</label>
